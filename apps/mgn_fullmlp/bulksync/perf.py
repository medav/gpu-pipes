...
def test_performance(NI=10000):
    ...
    y1 = torch.zeros(M, 128,   dtype=torch.float16, device='cuda')
    y2 = torch.zeros(M, 128,   dtype=torch.float16, device='cuda')
    y3 = torch.zeros(M, 128,   dtype=torch.float16, device='cuda')
